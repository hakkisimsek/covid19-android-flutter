...
class _IndiaScreenState extends State<IndiaScreen> {
  ...
  India d;
  String s = "http://www.oxitbilisim.com/covid-tr.json";
                      ...
                      (pointer) => Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                colorCard("Toplam Vaka", pointer.screend,
                                    context, Color(0xFF8fb9a8)),
                                colorCard("Aktif Vaka", pointer.activeIndia,
                                    context, Color(0xFFf1828d)),
                              ],
                            ),
                            Row(
                              children: <Widget>[
                                colorCard("Taburcu Edilen ", pointer.cured,
                                    context, Color(0xFF765d69)),
                                colorCard("Ölüm Vakaları", pointer.death, context,
                                    Color(0xFF685d79)),
                              ],
                            ),
                            Row(
                              children: <Widget>[
                                colorCard("Taşıyıcı Hasta", pointer.migration,
